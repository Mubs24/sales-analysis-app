...
def generate_pdf_b64(kpis, plot_b64, breakdowns, filename):
    ...
    pdf.cell(0, 15, text="Sales Analysis Report", align="C")
    pdf.ln(10)
    ...
    # We must use a temporary file to load the image into FPDF
    if plot_b64:
    ...
    # Output to a temporary file since FPDF2 stream returning is complex
